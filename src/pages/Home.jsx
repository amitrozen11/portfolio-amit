...
function Home() {
  return (
    <div className="relative min-h-screen bg-[#0d1117] text-white flex items-start px-16">
      <div className="max-w-4xl text-left w-2/3">

        <motion.h1
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }}
          className="text-7xl sm:text-8xl font-extrabold leading-tight text-white mb-4 font-sans"
        >
      ...
      >
        <div className="relative group">
          <img
            ...
            alt="Amit Rozen"
            className="rounded-2xl w-96 h-auto object-cover border border-gray-700"
          />
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-full
                    bg-black text-white text-xs px-4 py-2 rounded opacity-0 group-hover:opacity-100
                    transition duration-300 whitespace-nowrap z-10 shadow-md">
            Nice to meet you! 👋
          </div>
        </div>
      </motion.div>
